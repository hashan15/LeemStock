...
class ProductController extends Controller
{
    ...
    public function apiProducts(){
        ...
        return Datatables::of($product)
            ...
            ->addColumn('barcode_image', function ($product){
                return '<a href="https://barcode.tec-it.com/barcode.ashx?data='.$product->barcode->name.'&code=Code128&dpi=95&imagetype=JPG&download=true" style="margin: auto;display: block;text-align:center;" title="Download Barcode" target="_blank" download><img class="img-responsive img-thumbnail" src="https://barcode.tec-it.com/barcode.ashx?data='.$product->barcode->name.'&code=Code128&dpi=95 " style="width:100;"><br>Download</a>';
            })
	...
	{
		$Bid = $request->BarID;
        $product = Product::where('id','=',$Bid)->get();
